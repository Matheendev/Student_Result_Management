...
class CourseClass:
    def __init__(self,root):
        ...
        lbl_search_courseName = Label(self.root, text="Search By | Course Name:", font=("goudy old style", 15, "bold"), bg="white").place(x=620,y=60)
        txt_search_courseName = Entry(self.root, textvariable=self.var_search,font=("goudy old style", 15, "bold"), bg="white")
        txt_search_courseName.place(x=850,y=60,width=200,height=30)
